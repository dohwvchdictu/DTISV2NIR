                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-neutral-400">
                                        View all the pending and for action documents in your office.
                                    </p>
                                </div>
                                ...
                                <div>
                                        ...
                                        <div class="flex-1 min-w-[150px]">
                                            ...
                                            <div class="relative">
                                                <input wire:model.blur="search" type="text" id="search" name="search"
                                                    class="py-3 px-3 ps-11 block w-full border-gray-200 rounded-lg shadow text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                                    placeholder="Search">
                                                <div
                                    ...
                                    {{--
                                        ...
                                        queued before closing, endorsing or forwarding it. Selections survive a
                                        change of search or filter so a batch can be assembled across several
                                        searches, which means the selection can include documents that are not
                                        on screen.
                                        ...
                                        DOM from the start is how the Forward/Endorse/Close buttons beside it
                                        already work - Blade only toggles their disabled attribute.
                                    --}}
                                    <div @class([
                                    ...
                                    <div class="inline-flex rounded-lg shadow-sm gap-x-1">
                                        ...
                                        <button type="button" {{ count($this->selected_item) > 0 ? '' : 'disabled'
                                            ...
                                            aria-haspopup="dialog" aria-expanded="false"
                                            aria-controls="document-endorse-modal"
                                            data-hs-overlay="#document-endorse-modal"
                                            class="py-3 px-3 inline-flex items-center gap-x-2 text-sm font-medium
                                            rounded-lg border border-transparent bg-indigo-600 text-white
                                    ...
                                    <tr wire:key="document-{{ $document->id }}"
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <span class="block">
                                                ...
                                                <div class="px-6">
                                                    <span
                                                        class="inline-flex items-center gap-1.5 py-1 px-2 mt-2 rounded-lg text-xs font-medium bg-yellow-100 text-gray-800 dark:bg-yellow-500/20 dark:text-neutral-200">
