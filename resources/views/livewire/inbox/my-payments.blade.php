                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-neutral-400">
                                        View all of your created payments, track and more.
                                    </p>
                                </div>
                                ...
                                <div>
                                    <div class="flex flex-wrap gap-2 items-center">
                                        ...
                                        {{--
                                            ...
                                            filter, so the selection can include payments not on screen.
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <span class="block relative z-10">
                                                <div class="px-6 flex gap-x-1 text-sm text-gray-600 dark:text-neutral-400">
                                                    {{
                                                    Carbon\Carbon::parse($document->created_at)->format('D, M d,
                                                    Y')
                                                    }}
                                                </div>
                                                <div class="px-6 flex gap-x-1 text-sm text-gray-600 dark:text-neutral-400">
